...
function HeroBanner() {
  ...
  useEffect(() => {
    ...
    const cleanupResize = fitElementToParent(sphereEl);
          ...
          <svg
            ...
            <defs>
              <linearGradient
                ...
                y1="0%"
                y2="15%">
                <stop stopColor="#6608e1" offset="0%" />
                <stop stopColor="#160231" offset="50%" />
                <stop stopColor="#1f0245" offset="100%" />
              </linearGradient>
            </defs>
