          ...
          <div className="w-full h-full flex items-center justify-between gap-[3rem] lg:flex-row-reverse flex-col">
            <div className="lg:w-1/2  flex flex-col  rounded gap-[1rem]">
              ...
              <div className="flex flex-col gap-3">
                <p className="text">
                  Driven by a passion for innovation and excellence, our
                  dedicated team of experts harnesses the power of cutting-edge
                  artificial intelligence technologies to deliver unparalleled
                  solutions tailored to meet your unique needs. With a steadfast
                  commitment to quality and a track record of success, we strive
                  to exceed expectations and drive transformative results for
                  our clients.
                </p>
                <p className="text">
                  At the heart of our approach lies a collaborative spirit,
                  where every project is approached with creativity, precision,
                  and a relentless pursuit of excellence. As we continue to push
                  the boundaries of what&apos;s possible in the realm of AI, we
                  invite you to join us on this journey towards a future defined
                  by innovation and possibility
                </p>
              </div>
              <div>
