...
function Hero({}: Props) {
  return (
    <section
      className="w-screen h-screen flex items-center justify-center drop-shadow shadow  md:pt-[6rem] lg:p-0"
      id="home">
      <div className="container mx-auto p-5 flex items-center h-full flex-col md:flex-row">
        <div className="md:w-1/2 w-full h-full flex items-center flex-col justify-center gap-3 pt-[4rem] md:p-0">
          ...
          <div className="md:flex lg:items-center gap-3 justify-start w-full flex-col lg:flex-row items-start hidden">
