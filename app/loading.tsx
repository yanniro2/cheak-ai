    ...
    <section className="w-screen h-screen flex items-center justify-center  ">
      <div className="flex flex-col items-center gap-[1rem]">
        ...
        <Scroll className="flex items-center gap-5 lg:p-0 p-5">
          <h1 className="h1-default text-white uppercase">
            please wait it loading
          </h1>
          <div role="status">
            <svg
              aria-hidden="true"
              className="inline w-[1.5rem] h-[1.5rem] text-slate-800 animate-spin dark:text-slate-800 fill-primary"
              viewBox="0 0 100 101"
              fill="none"
